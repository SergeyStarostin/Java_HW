...
public class PromotionalClient extends Actor {
     ...
     *
     * @return true, если акционный клиент может делать заказы, в противном случае -
     *         false
     */
    @Override
     ...
     *
     * @return true, если акционный клиент может создавать заказы, в противном
     *         случае - false
     */
    @Override
     ...
     *
     * @param takeOrder значение возможности заказа (true - может делать заказы,
     *                  false - не может)
     */
    @Override
     ...
     *
     * @param makeOrder значение возможности создания заказа (true - может создавать
     *                  заказы, false - не может)
     */
    @Override
